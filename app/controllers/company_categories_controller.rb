class CompanyCategoriesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @company_category.save
        format.html { redirect_to company_category_url(@company_category), notice: "Company category was successfully created." }
  ...
  def update
    respond_to do |format|
      if @company_category.update(company_category_params)
        format.html { redirect_to company_category_url(@company_category), notice: "Company category was successfully updated." }
  ...
  private
    ...
    def company_category_params
      params.require(:company_category).permit(:name, :quota, :is_partner, :description, :active)
    end
end
